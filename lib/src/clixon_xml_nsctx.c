...
/* Callback used by yang_imports_foreach_module to add import prefix/ns to nsctx */
static int
               ...
               cvec     **ncp)
{
    ...
    /* Iterate over module and submodules and register all import prefixes. */
    ictx.nc = nc;
    ictx.yspec = yspec;
    if (yang_imports_foreach_module(ymod, yspec, nsctx_add_import_cb, &ictx) < 0)
        goto done;
    *ncp = nc;
    retval = 0;
 done:
